...
$tab = $categoryC->listCategories();
?>

    <h1>List of Categories</h1>
        <a class="btn btn-primary" href="addCategory.php" role="button">Add Category</a>
        <a class="btn btn-primary" href="event.php" role="button">Back</a>
        ...
        <tr>
            ...
            <td align="center">
                <form method="POST" action="updateCategory.php">
                    ...
                    <input type="hidden" value=<?= $category['idCategorie']; ?> name="idCategorie">
                </form>
            </td>
            <td>
                <a href="deleteCategory.php?id=<?= $category['idCategorie']; ?>" class='btn btn-danger btn-sm'>Delete</a>
            </td>
        </tr>
    <?php } ?>
    </tbody>
