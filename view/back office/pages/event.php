...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <h2>List of Events</h2>
            <a class="btn btn-primary" href="addEvent.php" role="button">Add New Event</a>
            <a class="btn btn-primary" href="listCategories.php" role="button">Gategorie</a>
            <br>
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <a href="deleteEvent.php?id=<?php echo $event['idevent']; ?>" class='btn btn-danger btn-sm'>Delete</a>
                </td>
            </tr>
        <?php
        }
